...
export class QrPrintThirdPartyFormMock {
  ...
  private generateQrImageSrc(
    ...
    return `${this.peQrApiPath}/api/download/${fileType}?${qrImageSrcParams.toString()}`;
  }
              ...
              operations: [
                {
                  ...
                  text: 'Preview',
                  request: {
                    url: `${this.peQrApiPath}/api/form/preview`,
                    method: 'post',
                  },
                },
                {
                  ...
                  text: 'Download',
                  request: {
                    url: `${this.peQrApiPath}/api/form/download`,
                    method: 'post',
                  },
                },
                {
                  ...
                  text: 'Print',
                  request: {
                    url: `${this.peQrApiPath}/api/form/print`,
                    method: 'post',
                  },
                },
              ] as any,
