...
describe('EditorMainSectionComponent', () => {
  ...
  const peDateTimePickerServiceSpy = jasmine.createSpyObj<PeDateTimePickerService>('PeDateTimePickerService', ['open']);
  ...
  beforeEach(
    waitForAsync(() => {
      ...
      sectionsServiceMock = {
        ...
        recurringBillingChange$: new Subject(),
        productType$: new Subject(),
        variantsSection: [],
        mainSection: [],
        contentSection: [],
        getUrl: () => {},
      ...
      TestBed.configureTestingModule({
        declarations: [EditorMainSectionComponent, TranslatePipe],
