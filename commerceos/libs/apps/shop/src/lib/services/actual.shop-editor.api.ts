...
export class PebActualEditorApi implements PebEditorApi {
  ...
  installTemplateTheme(themeId: string): Observable<PebShopThemeEntity> {
    return this.http.post<PebShopThemeEntity>(`${this.editorApiPath}/api/business/${this.envService.businessId}/application/${this.envService.applicationId}/theme/${themeId}/install`, {});
  }
  ...
  deleteTemplateTheme(themeId: string): Observable<void> {
    return this.http.delete<void>(`${this.editorApiPath}/api/business/${this.envService.businessId}/application/${this.envService.applicationId}/theme/${themeId}`, {});
  }

  duplicateTemplateTheme(themeId: string): Observable<PebShopThemeEntity> {
    return this.http.post<PebShopThemeEntity>(`${this.editorApiPath}/api/business/${this.envService.businessId}/application/${this.envService.applicationId}/theme/${themeId}/duplicate`, {});
  }
  ...
  getApp(appId: string = this.envService.applicationId): Observable<any> {
  ...
  updateApp(payload: any): Observable<any> {
    return this.http.patch<any[]>(
      `${this.shopApiPath}/business/${this.envService.businessId}/shop/${this.envService.applicationId}`,
      payload,
    );
  }
  ...
  getCurrentShopPreview(shopId: string, currentDetail: boolean, diff: boolean, page: string = null):
  ...
  getPageAlbumByParent(shopId: string, themeId: string, parentId: string): Observable<any> {
    return this.http.get<any>(
      `${this.editorApiPath}/api/application/${shopId}/theme/${themeId}/page-album/parent/${parentId}`);
  }
