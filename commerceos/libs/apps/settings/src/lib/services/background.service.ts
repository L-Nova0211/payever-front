...
export class BackgroundService {
  ...
  setBackgroundImageThroughOverlayFromBlob(
    blobName: string,
    blobContainer: string,
    elementSelector: string,
    overlayElementSelector: string
  ): void {
    this.setBackgroundImageThroughOverlay(
      this.mediaUrlPipe.transform(blobName, blobContainer),
      elementSelector,
