...
@Component({
  selector: 'peb-editor-language-chinese-icon',
  template: `
    <svg width="12" height="12" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
...
export class PebEditorLanguageChineseComponent {
}
