...
import * as pebEditor from '@pe/builder-main-editor';
import { PebEditor } from '@pe/builder-main-editor';
import { PebActionType, PebEditorAccessorService, PebEditorStore } from '@pe/builder-services';
...
import { PebEditorBlogMasterPageChangesPlugin } from './master-page-changes.plugin';

describe('PebEditorBlogMasterPageChangesPlugin', () => {

  let plugin: PebEditorBlogMasterPageChangesPlugin;
  ...
  beforeEach(() => {
    ...
    plugin = TestBed.inject(PebEditorBlogMasterPageChangesPlugin);
