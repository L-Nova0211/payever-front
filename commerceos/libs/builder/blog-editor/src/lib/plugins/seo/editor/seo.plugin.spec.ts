...
import { PebEditorBlogSeoPlugin } from './seo.plugin';
import { PebEditorBlogSeoSidebarComponent } from './seo.sidebar';

describe('PebEditorBlogSeoPlugin', () => {

  let plugin: PebEditorBlogSeoPlugin;
  let editorComponent: {
  ...
  beforeEach(() => {
    ...
    plugin = TestBed.inject(PebEditorBlogSeoPlugin);
